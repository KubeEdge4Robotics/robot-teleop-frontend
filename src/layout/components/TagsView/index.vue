...
import {
  type ITagView,
  useRobotViewStore,
} from "@/store/module/robotViewStore";
...
.tags-view-container {
  height: var(--robo-tagsview-height);
  width: 100%;
  ...
  .tags-view-wrapper {
    .tags-view-item {
      ...
      height: 26px;
      line-height: 26px;
      border: 1px solid var(--robo-tagsview-tag-border-color);
      border-radius: var(--robo-tagsview-tag-border-radius);
      color: var(--robo-tagsview-tag-text-color);
      background-color: var(--robo-tagsview-tag-bg-color);
      padding: 0 8px;
      font-size: 12px;
      margin-left: 5px;
      margin-top: 4px;
      ...
      &.active {
        background-color: var(--robo-tagsview-tag-active-bg-color);
        color: var(--robo-tagsview-tag-active-text-color);
        border-color: var(--robo-tagsview-tag-active-border-color);
        &::before {
          content: "";
          background-color: var(--robo-tagsview-tag-active-before-color);
          display: inline-block;
          width: 8px;
          height: 8px;
          border-radius: 50%;
      ...
      .el-icon {
        ...
        border-radius: 50%;
        &:hover {
          background-color: var(--robo-tagsview-tag-icon-hover-bg-color);
          color: var(--robo-tagsview-tag-icon-hover-color);
        }
      }
    }
  }
